...
```bash
curl -s https://api.dev.yourorg.com.br/health | jq
curl -s https://api.dev.yourorg.com.br/health/readiness | jq  # verifica DB + S3
curl -s https://api.dev.yourorg.com.br/health/liveness | jq
```

### Verificar ECS service
```bash
export AWS_PROFILE=YourOrg-Dev
...
aws sesv2 get-email-identity --email-identity dev.yourorg.com.br --region us-east-1 --query '{Verified:VerifiedForSendingStatus}'
...
**Resolucao**:
1. Verificar se callback URL esta correto no Cognito (deve ser `https://app.dev.yourorg.com.br/auth/callback`)
2. Verificar se custom domain (`authentication.app.dev.yourorg.com.br`) resolve
...
aws sqs get-queue-attributes --queue-url https://sqs.us-east-1.amazonaws.com/222222222222/tecksign-dev-events \
  --attribute-names ApproximateNumberOfMessages,ApproximateNumberOfMessagesNotVisible \
  --region us-east-1

# Verificar DLQ
aws sqs get-queue-attributes --queue-url https://sqs.us-east-1.amazonaws.com/222222222222/tecksign-dev-events-dlq \
