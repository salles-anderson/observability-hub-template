...
| Repo | Branch | URL |
|------|--------|-----|
| tecksign-api | develop | https://github.com/YourOrg/tecksign-api |
| tecksign-frontend | develop | https://github.com/YourOrg/tecksign-frontend |
| tecksign-infra | main | https://github.com/YourOrg/tecksign-infra |

### Terraform Cloud Workspaces

| Workspace | Camada | URL |
|-----------|--------|-----|
| tecksign-ses-develop | BASE (SES) | https://app.terraform.io/app/YourOrg/workspaces/tecksign-ses-develop |
| tecksign-base-develop | BASE (VPC, RDS, S3, Cognito) | https://app.terraform.io/app/YourOrg/workspaces/tecksign-base-develop |
| tecksign-app-develop | APP (ECS, ALB, Amplify) | https://app.terraform.io/app/YourOrg/workspaces/tecksign-app-develop |

### AWS Account

- **Account ID**: 222222222222 (YourOrg-Dev)
- **Region**: us-east-1
- **Dominio**: *.dev.yourorg.com.br
- **VPC**: vpc-0b2b2b2b2b2b2b2b2 (172.19.0.0/16) — vpc-core-infra-dev-vpc
...
| Servico | URL |
|---------|-----|
| Frontend App | https://app.dev.yourorg.com.br |
| Frontend Admin | https://admin.dev.yourorg.com.br |
| API | https://api.dev.yourorg.com.br |
| Cognito Auth | https://authentication.app.dev.yourorg.com.br |
| Swagger Docs | https://api.dev.yourorg.com.br/docs |
| Health Check | https://api.dev.yourorg.com.br/health |
| Metrics | https://api.dev.yourorg.com.br/metrics |
...
SMTP_PORT=587, SMTP_FROM=noreply@dev.yourorg.com.br
...
# CORS
CORS_ORIGINS=https://app.dev.yourorg.com.br,https://admin.dev.yourorg.com.br
```
...
- **Admin**: subdomain `admin.dev.yourorg.com.br` (client ID separado)
...
### Networking
- **VPC**: vpc-0b2b2b2b2b2b2b2b2 (172.19.0.0/16)
...
- **Custom Domain**: authentication.app.dev.yourorg.com.br
- **MFA**: TOTP habilitado
...
- **Repo**: YourOrg/tecksign-frontend
- **Branch**: develop
- **Domains**: app.dev.yourorg.com.br, admin.dev.yourorg.com.br

### Route53 DNS

| Record | Destino |
|--------|---------|
| api.dev.yourorg.com.br | ALB (Alias A/AAAA) |
| app.dev.yourorg.com.br | Amplify (CNAME) |
| admin.dev.yourorg.com.br | Amplify (CNAME) |
| authentication.app.dev.yourorg.com.br | Cognito Custom Domain (A) |
...
A conta YourOrg-Dev (222222222222) tambem hospeda o projeto **Gestao Cartao**:
