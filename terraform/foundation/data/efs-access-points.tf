# -----------------------------------------------------------------------------
# EFS Access Points  Pontos de acesso para persistência de dados dos serviços de observabilidade
# -----------------------------------------------------------------------------
# Referenciam aws_efs_file_system.this[0].id LOCAL (mesmo workspace data).
# O access point do Grafana, que no monolito morava em grafana.tf, foi trazido
# para ca (decomposicao): o file system e os access points sao todos data. O
# servico grafana (no build) consome o AP via output deste workspace.
...
# -----------------------------------------------------------------------------
# Access Point - Grafana (no monolito morava em grafana.tf; SEM count)
# -----------------------------------------------------------------------------
